...
if __name__=='__main__':
    ...
    test_data = 'new_data6.mat' #new_data_OrigScale3.mat
    ...
    with tf.Session() as sess:  
        ...
        sio.savemat('./result/output_panNet2_newdata6_iter20wan.mat', {'output_panNet2_newdata6_iter20wan':final_output[0,:,:,:]})
        #_OrigScale3