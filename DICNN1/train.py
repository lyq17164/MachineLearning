...
def PanNet(ms, pan, num_spectral = 8, num_res = 4, num_fm = 32, reuse=False):
    ...
    with tf.variable_scope('net'):        
        ...
        ms = tf.concat([ms,pan],axis=3)  # ms + pan: put together (concat) 
...
if __name__ =='__main__':
    ...
    train_data_name = './training_data/train1.mat'  # training data
    test_data_name  = './training_data/validation1.mat'   # validation data
